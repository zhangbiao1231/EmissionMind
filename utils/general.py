...
DATASETS_DIR = Path(os.getenv("EMISSION_DATASETS_DIR", ROOT / "datasets/min-level/processed"))  # global datasets directory
#DATASETS_DIR = Path(os.getenv("EMISSION_DATASETS_DIR", ROOT / "datasets/second-level/processed"))  # global datasets directory
